...
void loop()
{
  ...
  json_request["nowtime"] = buf;
  json_request["weight"] = nowDayData.sensorsValue[0];
  json_request["activeCount"] = nowDayData.sensorsValue[1];
  json_request["temperature"] = nowDayData.sensorsValue[2];
  json_request["wheelCount"] = nowDayData.sensorsValue[3];
  json_request["houseCount"] = nowDayData.sensorsValue[4];
  json_request["humidity"] = nowDayData.sensorsValue[5];
